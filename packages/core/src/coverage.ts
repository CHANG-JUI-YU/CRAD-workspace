...
export const urlIngestionSchema = z.object({
  ...
  operation_id: z.string().min(1),
  url: z.string().min(1),
  requested_url: z.string().min(1).optional(),
  ...
  next_actions: z.array(z.enum(["retry", "change_url"])).optional(),
  retry_of: z.string().optional(),
  successor_of: z.string().optional(),
  source_id: z.string().optional(),
  route: z.enum(["coverage_supplement", "coverage_research_recover"]).optional(),
