...
export const AGENT_DEFINITIONS: readonly AgentDefinition[] = [
  ...
  definition("zhuji-creator", "creator", ".agents/agents/zhuji-creator.md", "zhuji-creator", "zhuji-creation", ["character-authoring", "zhuji"]),
  definition("palette-creator", "creator", ".agents/agents/palette-creator.md", "palette-creator", "palette-creation", ["character-authoring", "palette"]),
  definition("wardrobe-creator", "creator", ".agents/agents/wardrobe-creator.md", "wardrobe-creator", "wardrobe-creation", ["character-authoring", "wardrobe"]),
