...
export const toolDefinitions = [
  ...
  },
  {
    ...
    inputSchema: templateProposalJsonSchema,
  },
  {
    ...
    try {
      ...
      if (request.method === "POST" && url.pathname === "/mcp") {
        ...
        if (parsed.method === "initialize") {
          json(response, 200, { jsonrpc: "2.0", id, result: { protocolVersion: "2025-06-18", capabilities: { tools: {} }, serverInfo: { name: "st-workspace-v3", version: "0.1.0" } } });
          return;
        }
